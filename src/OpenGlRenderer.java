...
public class OpenGlRenderer {
    ...
    public void updateVao(Entity entity){

        float vertices[] = entity.getVertices();
        byte indices[] = entity.getIndices();
    ...
    public void drawEntity(Entity entity){
        ...
        FloatBuffer orthoBuffer = BufferUtils.createFloatBuffer(ortho_matrix.length);
        ...
        GL11.glDrawElements(entity.getOpenGLDrawingMethod(), entity.getIndices().length, GL11.GL_UNSIGNED_BYTE, 0 );
